...
# Script de despliegue simplificado para Dashboard Codexa en VPS
# Este script automatiza el proceso de despliegue en una ubicación simple

echo "=== Despliegue Simplificado de Dashboard Codexa ==="
...
mkdir -p /home/localroot/dashboard

echo "2. Navegando al directorio..."
cd /home/localroot/dashboard

echo "3. Copiando archivo comprimido..."
